class ChatService(
    ...
    private var chatNextId: Int = 1,
    private var messageNextId: Int = 1,
    ...
    fun deleteMessage(currentChatId: Int, currentMessageId: Int) {
        chats
            ...
            .apply {
                this?.messages ?: throw ChatNotFoundException("Чат не существует")
    ...
    fun getMessages(currentChatId: Int, currentMessageId: Int, count: Int, currentUserId: Int): List<Chat.Message> {
        val currentChat = chats
            .find { it.chatId == currentChatId } ?: throw ChatNotFoundException("Чат не существует")
